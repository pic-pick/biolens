<template>
  <Teleport to="body">
    ...
    <!-- 우측 슬라이드 패널 -->
    <div class="fixed right-0 top-0 h-screen w-[520px] max-w-[95vw] z-50 bg-surface border-l border-slate-800 flex flex-col shadow-2xl animate-slide-in-right overflow-hidden">
      ...
      <!-- 하단 액션 -->
      <div class="px-6 py-4 border-t border-slate-800 shrink-0 flex gap-2">
        <button
          v-if="result"
